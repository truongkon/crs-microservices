...
export default function ApiKeysPage() {
    ...
    return (
        <div style={{ padding: 24, maxWidth: 800, margin: '0 auto' }}>
            ...
            <form onSubmit={handleCreate} style={{ border: '1px solid #ddd', padding: 16,
                ...
                <div style={{ marginBottom: 8 }}>
                    ...
                    <input type="number" value={validDays} onChange={(e) =>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    {keys.map((k) => (
                        <tr key={k.id} style={{ borderBottom: '1px solid #eee' }}>
                            ...
                            <td>{k.expiresAt ? new Date(k.expiresAt).toLocaleDateString('vi-VN') :
                                'Vinh vien'}</td>
                            <td>
                                {k.status === 'ACTIVE' && (
